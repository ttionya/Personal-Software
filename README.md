...
- VMware ([官网](https://www.vmware.com/products/desktop-hypervisor/workstation-and-fusion)、[下载(需登录)](https://support.broadcom.com/group/ecx/productdownloads?subfamily=VMware%20Workstation%20Pro&freeDownloads=true)) - 虚拟机
...
- QQ ([官网](https://im.qq.com/)、[下载](https://im.qq.com/index/#downloadAnchor))
...
- Cursor ([官网](https://www.cursor.com/)、[下载](https://www.cursor.com/downloads))
- Visual Studio Code ([官网](https://code.visualstudio.com/)、[下载](https://code.visualstudio.com/download))
...
- FastGPT ([官网](https://tryfastgpt.ai/)、[GitHub](https://github.com/labring/FastGPT))
...
- Chatbox ([官网](https://chatboxai.app/)、[下载](https://chatboxai.app/#download)、[GitHub](https://github.com/Bin-Huang/chatbox))
- Cherry Studio ([官网](https://cherry-ai.com/)、[下载](https://cherry-ai.com/download)、[GitHub](https://github.com/CherryHQ/cherry-studio))
