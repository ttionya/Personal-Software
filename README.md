...
- 火绒 ([官网](https://www.huorong.cn/)、[下载](https://www.huorong.cn/person)) - 安全软件
...
- 微PE工具箱 ([官网](https://www.wepe.com.cn/)、[下载](https://www.wepe.com.cn/download.html)) - PE 系统制作工具
- CPU-Z ([官网](https://www.cpuid.com/softwares/cpu-z.html))
- GPU-Z ([官网](https://www.techpowerup.com/gpuz/)、[下载](https://www.techpowerup.com/download/techpowerup-gpu-z/))
...
- VMware ([官网](https://www.vmware.com/products/desktop-hypervisor/workstation-and-fusion)) - 虚拟机
...
- 钉钉 ([官网](https://www.dingtalk.com/)、[下载](https://www.dingtalk.com/download))
- 飞书 ([官网](https://www.feishu.cn/)、[下载](https://www.feishu.cn/download))
- 企业微信 ([官网](https://work.weixin.qq.com/)、[下载](https://work.weixin.qq.com/#indexDownload))
...
- WinRAR ([官网](https://www.rarlab.com/)、[下载](https://www.rarlab.com/download.htm))
- 7-ZIP ([官网](https://www.7-zip.org/)、[下载](https://www.7-zip.org/download.html)、[GitHub](https://github.com/ip7z/7zip))
...
- frp ([官网](https://gofrp.org/)、[GitHub](https://github.com/fatedier/frp))
- ZeroTier One ([官网](https://www.zerotier.com/)、[下载](https://www.zerotier.com/download/)、[GitHub](https://github.com/zerotier/ZeroTierOne))
- Hamachi ([官网](https://vpn.net/))
...
- AirDroid Cast ([官网](https://www.airdroid.com/cast/)、[下载](https://www.airdroid.com/download/airdroid-cast/)) - 投屏工具
...
- Logseq ([官网](https://logseq.com/)、[下载](https://logseq.com/downloads)、[GitHub](https://github.com/logseq/logseq))
...
- Bun ([官网](https://bun.sh/)、[下载](https://bun.com/get))
- Rust ([官网](https://rust-lang.org/)、[下载](https://rust-lang.org/tools/install/))
...
- Windows Terminal ([下载](https://apps.microsoft.com/detail/9n0dx20hk701))
- Tabby ([官网](https://tabby.sh/)、[GitHub](https://github.com/Eugeny/tabby))
- WinSCP ([官网](https://winscp.net/eng/index.php)、[下载](https://winscp.net/eng/download.php)、[GitHub](https://github.com/winscp/winscp))
...
- Wireshark ([官网](https://www.wireshark.org/)、[下载](https://www.wireshark.org/download.html)、[GitLab](https://gitlab.com/wireshark/wireshark/))
- Whistle ([官网](https://wproxy.org/)、[GitHub](https://github.com/avwo/whistle)) - 调试代理工具
...
- Ollama ([官网](https://ollama.com/)、[下载](https://ollama.com/download)、[GitHub](https://github.com/ollama/ollama))
...
- Chatbox ([官网](https://chatboxai.app/)、[下载](https://chatboxai.app/#download)、[GitHub](https://github.com/chatboxai/chatbox))
- Cherry Studio ([官网](https://www.cherry-ai.com/)、[下载](https://www.cherry-ai.com/download)、[GitHub](https://github.com/CherryHQ/cherry-studio))

<br>

## VPN

- OpenVPN ([官网](https://openvpn.net/)、[下载](https://openvpn.net/community/))
...
- Parsec ([官网](https://parsec.app/)、[下载](https://parsec.app/downloads))

### 音视频

#### 播放器

- Foobar2000 ([官网](https://www.foobar2000.org/)、[发布页](https://www.cnblogs.com/asionwu)) - 音乐播放器 (Asion)
- PotPlayer ([官网](https://potplayer.daum.net/)、[发布页](https://potplayer.org/)) - 视频播放器
- 弹弹play ([官网](https://www.dandanplay.com/)、[下载](https://kaedei.lanzouo.com/s/dandanplay)) - 动漫播放器
